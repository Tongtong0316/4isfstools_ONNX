...
pub struct SeparationEngineHealth {
    ...
    pub high_quality_model_file_ready: bool,
    pub high_quality_torch_ready: bool,
    pub high_quality_runtime_ready: bool,
...
impl Default for SeparationEngineHealth {
    fn default() -> Self {
        Self {
            ...
            high_quality_model_file_ready: false,
            high_quality_torch_ready: false,
            high_quality_runtime_ready: false,
